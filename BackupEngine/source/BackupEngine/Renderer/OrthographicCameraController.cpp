...
namespace BackupEngine {
	...
	void OrthographicCameraController::OnEvent(Event& ev)
	{
		...
		dispacher.Dispatch<MouseScrolledEvent>(BC_BIND_EVENT_FN(OrthographicCameraController::OnMouseScrolled));
		dispacher.Dispatch<WindowResizeEvent>(BC_BIND_EVENT_FN(OrthographicCameraController::OnWindowResized));
	}
